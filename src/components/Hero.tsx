        ...
        <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel" data-bs-interval="8000">
          <div className="carousel-inner">
            <div className="carousel-item active">
              <img src="/assets/images/_image.webp" className="d-block w-100" alt="Image-Slider One" loading="eager" />
            </div>
            <div className="carousel-item">
              <img src="/assets/images/_image (2).webp" className="d-block w-100" alt="Image-Slider Two" loading="lazy" />
            </div>
            <div className="carousel-item">
              <img src="/assets/images/_image (3).webp" className="d-block w-100" alt="Image-Slider Three" loading="lazy" />
            </div>
            <div className="carousel-item">
              <img src="/assets/images/download (10).jfif" className="d-block w-100" alt="Image-Slider Four" loading="lazy" />
            </div>
            <div className="carousel-item">
              <img src="/assets/images/1370159.png" className="d-block w-100" alt="Image-Slider Five" loading="lazy" />
            </div>
            <div className="carousel-item">
              <img src="/assets/images/image(4).jpg" className="d-block w-100" alt="Image-Slider Six" loading="lazy" />
            </div>
            <div className="carousel-item">
              <img src="/assets/images/image(5).webp" className="d-block w-100" alt="Image-Slider Seven" loading="lazy" />
            </div>
            <div className="carousel-item">
              <img src="/assets/images/image(6).jpg" className="d-block w-100" alt="Image-Slider Eight" loading="lazy" />
            </div>
          </div>
