...
export const projectsData: Record<string, ProjectData> = {
  'New-Portfolio': {
    ...
    technologies: ['React', 'TypeScript', 'SCSS', 'Bootstrap', 'Vite'],
    image: '/assets/images/_image.webp',
    highlights: ['Dynamic project gallery and contact section', 'Fully responsive with smooth animations', 'Built using modular SCSS and TypeScript'],
    learning: 'Improved my experience in TypeScript and project component structure with React + Vite.'
  },
  'Kasper-Template': {
    ...
    image: '/assets/images/_image (2).webp',
  ...
  'Leon-Template': {
    ...
    image: '/assets/images/_image (3).webp',
